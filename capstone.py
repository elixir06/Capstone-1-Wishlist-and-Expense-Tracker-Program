...
import datetime
#headers
header = ["Category","Date","Description","Amount"]
header_dream = ["Dream","Target","Amount"]
header_analysis = ["Dream","Target","Days Left","Amount"]
...
def add_dream():
    ...
    while True:
        ...
        if price_dream.isdigit():
            ...
            days_left = time_delta.days #to find the time remaining in days 
...
def delete_dream():
    ...
    while True :
        if len(dream_list) == 0:
            ...
            del_dream_user = int(input("delete which wishlist ? "))
    ...
    while True :
        ...
        if user.upper() == "I":
            ...
            if len(income_history) == 0:
                ...
                while True:
                    prompt = int(input("delete which index ? \n"))
    ...
    while True:
        ...
        if user.upper() == "I":
            ...
            if len(income_history) == 0:
                ...
                while True:
                    prompt = int(input("Update which index ? \n"))
                    if prompt > len(income_history)-1 or prompt < 0:
                        print("index not available\n")
                    else :
...
def analysis():
    ...
    daysleft = num_days_in_month - now.day
